...
class MyTest(unittest.TestCase):
    def test(self):
        ...
        self.assertEqual(BinaryConverter.convert_dec_to_bin(50.35), 110010.0101100110011001101)
        ...
        self.assertEqual(BinaryConverter.convert_bin_to_dec(11001101.0111111), 205.4921875)
