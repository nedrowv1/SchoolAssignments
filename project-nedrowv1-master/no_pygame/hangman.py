...
def new_game():
        wordlist = {'abode':'a home','access':'an outburst of an emotion',
                    ...
                    'shade':'a ghost','ship of the desert':'a camel',
                    'shore':'country by the sea','slay':'kill','slumber':'sleep',
                    'star-crossed':'ill-fated','steed':'a horse','stilly':'still and quiet',
                    'storied':'celebrated in stories','strand':'a shore','Stygian':'very dark',
                    'summer':'a year of a personss age',
                    ...
                    'tarry':'delay leaving','temerarious':'rash or reckless',
                    'tenebrous':'dark; shadowy','threescore':'sixty',
                    'thrice':'three times','tidings':'news; information',
                    'toilsome':'involving hard work','tope':'drink alcohol to excess',
                    'travail':'painful or laborious effort','troublous':'full of troubles',
                    'tryst':'a rendezvous between lovers',
                    'unman':'deprive of manly qualities','vestal':'chaste; pure',
                    'vesture':'clothing','virescent':'greenish',
                    'viridescent':'greenish or becoming green',
                    'visage':'a persons face','want':'lack or be short of',
                    'wax':'become larger or stronger',
                    'wayfarer':'a person who travels on foot','wed':'marry',
                    'wind':'blow (a bugle)',
                    'without':'outside','wondrous':'inspiring wonder','wont':'accustomed',
                    'wonted':'usual','wrathful':'extremely angry','wreathe':'twist or entwine',
                    'yon':'yonder; that','yore':'of former ties or long ago',
                    'youngling':'a young person or animal','zephyr':'a soft, gentle breeze'}
        word, definition = random.choice(list(wordlist.items()))
        win = hangman(word, definition)
